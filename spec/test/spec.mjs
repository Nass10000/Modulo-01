const { Activity,Repository  } = import("../scripts/index.js");
...
describe("Debe tener una clase Repository", function () {
    
  it("Debe de ser una clase", function() {
   expect(typeof Repository.prototype.constructor).toBe("function");
    //expect(typeof Repository).toEqual('object'); // Comprobamos que repository sea un objeto ya que es una instancia de la clase Repository
    //expect(repository.constructor).toBeDefined(); // Comprobamos que el constructor de la instancia definido y accesible
  });
